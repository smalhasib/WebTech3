...
<section class="bg-white">
  <div class="py-8 px-2 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
    <div class="w-full flex flex-col justify-center items-center mb-8 lg:mb-16">
     <h1 class="text-[3rem] text-[#142580] font-bold before:content-[-]">Features</h1>
      <div class="w-[150px] bg-[#142580] h-[5px]"></div>
    </div>
    <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
      <div>
        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-[#142580] lg:h-12 lg:w-12">
        ...
        <h3 class="mb-2 text-xl font-bold">Classes</h3>
        <p class="text-gray-500">Lorem ipsum dolor sit amet, consectetur adipisicing elit. At atque fugiat qui. Aperiam ducimus facere facilis quibusdam! Dolorum, illo, rerum.</p>
      </div>
      <div>
        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-[#142580]  lg:h-12 lg:w-12">
        ...
        <h3 class="mb-2 text-xl font-bold">Exams</h3>
        <p class="text-gray-500 dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Autem consectetur et impedit ipsum itaque magni modi, nam reiciendis veniam. Porro.</p>
      </div>
      <div>
        <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-[#142580]  lg:h-12 lg:w-12">
        ...
        <h3 class="mb-2 text-xl font-bold">Discussion</h3>
        <p class="text-gray-500">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores eos ipsam labore molestiae nihil officiis pariatur quae reiciendis rerum, vitae.</p>
      </div>
